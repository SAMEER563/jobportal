...
const JobDescription = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-between'>
      ...
      <Button disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-purple-500 hover:bg-purple-700' }`}>{ isApplied ? 'Applied' : 'Apply Now'}</Button>
     </div>
     ...
     <div className='my-4'>
       ...
       <h1 className='font-bold my-1 '>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis, unde!</span></h1>
       ...
       <h1 className='font-bold my-1 '>Posted Date: <span className='pl-4 font-normal text-gray-800'>14-09-2024</span></h1>
     </div>
    </div>
  )
}
